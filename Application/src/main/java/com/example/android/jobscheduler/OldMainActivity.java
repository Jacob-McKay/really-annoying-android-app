...
public class OldMainActivity extends Activity {
    ...
    public void cancelAllJobs(View v) {
        JobScheduler tm = (JobScheduler) getSystemService(Context.JOB_SCHEDULER_SERVICE);
        tm.cancelAll();
        Toast.makeText(OldMainActivity.this, R.string.all_jobs_cancelled, Toast.LENGTH_SHORT).show();
    }
    ...
    public void finishJob(View v) {
        ...
        if (allPendingJobs.size() > 0) {
            ...
            Toast.makeText(
                    OldMainActivity.this, String.format(getString(R.string.cancelled_job), jobId),
                    Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(
                    OldMainActivity.this, getString(R.string.no_jobs_to_cancel),
                    Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static class IncomingMessageHandler extends Handler {
        ...
        private WeakReference<OldMainActivity> mActivity;

        IncomingMessageHandler(OldMainActivity activity) {
        ...
        public void handleMessage(Message msg) {
            OldMainActivity mainActivity = mActivity.get();
